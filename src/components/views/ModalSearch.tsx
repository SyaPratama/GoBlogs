...
export default function ModalSearch({
  ...
  return (
    <div className="w-full min-h-dvh m-auto flex items-start pt-14 justify-center">
      <div
        ref={modal}
        className="absolute z-50 md:w-lg w-64 h-auto bg-white overflow-hidden rounded-md border border-b-3 border-slate-300"
      >
        ...
        <div className="inline-flex items-center justify-between font-medium px-4.5 py-2.5">
          <div className="md:text-[10px] text-[9px] bg-slate-200/50 px-2 ring-1 ring-slate-600/25 py-1 rounded-sm">
